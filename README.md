...
On-Chain Price Adapter for fetching market real-time prices from DEXs like Uniswap V3, Curve, ... or e.g. Chainlink. Designed for seamless integration with DeFi protocols such as Morpho Markets, Oracles, ...
